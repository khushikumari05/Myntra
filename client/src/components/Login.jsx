         ...
         <div className='bg-rose-50 h-screen flex flex-col justify-center items-center'>
            <div className='h-96 w-96 bg-white flex flex-col justify-center items-center'>
                ...
                <PhoneInput
                    ...
                    <h1 className='text-xs text-gray-400'> By Clicking continue, you can <span className='text-rose font-bold'>login to this myntra clone</span></h1>
                    <button className='bg-rose-500 text-white w-80 font-bold py-2 px-4 text-sm'></button>
                </div>}
